...
тесты сваливались если нет соединения и без лишней проверки, хотя и сейчас свалятся
при отсутсвии связи там же, только вот если произошел сбой или же имеется хитрая
